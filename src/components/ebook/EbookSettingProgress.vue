    ...
    <div class="setting-wrapper" v-show="menuVisible && settingVisible === 2">
      <div class="setting-progress">
        ...
        <div class="text-wrapper">
          ...
          <span class="progress-text">{{ bookAvailable ? this.progress + '%' : '加载中...'}}</span>
        </div>
      </div>
    </div>
  </transition>
...
import { getSection, saveSection } from '../../utils/localStorage'
export default {
  mixins: [ebookMixin],
  computed: {
    getSectionName () {
  ...
  methods: {
    ...
    prevSection () {
      if (this.section > 0 && this.bookAvailable) {
        ...
        saveSection(this.fileName, this.section)
      }
    },
    nextSection () {
      // console.log(this.section)
      getSection(this.fileName)
